...
LOCALE_PATHS = [
    os.path.join(BASE_DIR, 'diagnostic_feedback/translations'),
]

# statici18n
# http://django-statici18n.readthedocs.io/en/latest/settings.html

with open(os.path.join(BASE_DIR, 'diagnostic_feedback/translations/config.yaml'), 'r') as locale_config_file:
...
STATICI18N_NAMESPACE = 'DiagnosticFeedbackXBlockI18N'
STATICI18N_PACKAGES = (
    'diagnostic_feedback',
)
STATICI18N_ROOT = 'diagnostic_feedback/public/js'
